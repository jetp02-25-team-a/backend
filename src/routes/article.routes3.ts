...
// import { jwtParseMiddleware, requireAuth } from '../middleware/jwt.js'; // sesuaikan dengan middleware kamu
...
//   },
// });
// console.log(postWithLikes._count.Likes); // jumlah likes
...
//   },
//   update: {}, // tidak melakukan update jika sudah ada
 ...
 * ============================
 * POST /post/:id/like
 * Tambahkan atau hapus like untuk artikel
 * ============================
 */
// 
...
// router.use(articleRouter); // jika ada

//export default router;
/**
 * ============================
 * GET /post/:id/likes
 * Ambil jumlah total likes dari satu artikel
 * ============================
 */
