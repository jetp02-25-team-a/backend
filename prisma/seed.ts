...
const TAIWAN_CITY_BBOX: {
  ...
  臺北市: { lat: { min: 25.0, max: 25.15 }, lng: { min: 121.5, max: 121.6 } }, // 集中市區
  新北市: { lat: { min: 24.95, max: 25.15 }, lng: { min: 121.4, max: 121.7 } }, // 板橋、新莊、中永和一帶
  桃園市: { lat: { min: 24.9, max: 25.05 }, lng: { min: 121.2, max: 121.4 } }, // 桃園/中壢區
  臺中市: { lat: { min: 24.1, max: 24.25 }, lng: { min: 120.6, max: 120.75 } }, // 西屯、西區、北區一帶
  臺南市: { lat: { min: 22.95, max: 23.05 }, lng: { min: 120.15, max: 120.3 } }, // 中西區、東區一帶
  高雄市: { lat: { min: 22.6, max: 22.75 }, lng: { min: 120.25, max: 120.38 } }, // 鹽埕、苓雅、三民一帶

  // 次級城市
  基隆市: { lat: { min: 25.1, max: 25.15 }, lng: { min: 121.73, max: 121.78 } }, // 集中於港區
  新竹市: {
    lat: { min: 24.75, max: 24.85 },
    lng: { min: 120.95, max: 121.05 },
  }, // 集中市區
  嘉義市: { lat: { min: 23.45, max: 23.5 }, lng: { min: 120.4, max: 120.5 } }, // 市區很小，範圍不變

  // 縣市
  新竹縣: { lat: { min: 24.7, max: 24.8 }, lng: { min: 121.0, max: 121.15 } }, // 竹北/竹東一帶
  宜蘭縣: { lat: { min: 24.6, max: 24.8 }, lng: { min: 121.7, max: 121.8 } }, // 宜蘭/羅東平原區
  花蓮縣: { lat: { min: 23.9, max: 24.05 }, lng: { min: 121.55, max: 121.65 } }, // 集中花蓮市區
  臺東縣: { lat: { min: 22.75, max: 22.85 }, lng: { min: 121.1, max: 121.18 } }, // 集中台東市區
  // 其他縣市，維持原範圍 (或自行調整縮小)
  ...
  // 離島
  澎湖縣: { lat: { min: 23.5, max: 23.6 }, lng: { min: 119.55, max: 119.65 } }, // 馬公市區周邊
  金門縣: { lat: { min: 24.4, max: 24.45 }, lng: { min: 118.3, max: 118.4 } }, // 金城/金湖一帶
  連江縣: { lat: { min: 26.15, max: 26.25 }, lng: { min: 119.9, max: 120.0 } }, // 南竿/北竿一帶
